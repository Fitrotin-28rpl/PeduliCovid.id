...
<head>
    ...
    <title>PeduliCovid|Form Check Up</title>
...
if(@$_POST ['jawab']){
    ...
    if($_POST['suhu']>36){
        ...
        $terdeteksi= mysqli_query($connect, "INSERT INTO kondisi (nama, jeniskelamin, usia, alamat, suhu, jawaban1, jawaban2, jawaban3,jawaban4, jawaban5, hasil)
        ...
        $hasilaman="aman";
        $terdeteksi= mysqli_query($connect, "INSERT INTO kondisi (nama, jeniskelamin, usia, alamat, suhu, jawaban1, jawaban2, jawaban3,jawaban4, jawaban5, hasil)
        VALUES ('$namalengkap','$jeniskelamin','$usia','$alamat', '$suhu','$jawaban1','$jawaban2','$jawaban3','$jawaban4','$jawaban5','$hasilaman')");
    }
    else{
